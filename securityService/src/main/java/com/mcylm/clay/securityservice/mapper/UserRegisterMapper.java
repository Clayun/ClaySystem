...
public interface UserRegisterMapper {
    ...
    @Insert("insert into pre_common_ucenter_details(uuid,cn_Name,en_Name,sex,job,education,school,locationId,content,birthday) values(#{uuid},#{cn_Name},#{en_Name},#{sex},#{job},#{education},#{school},#{locationId},#{content},now()) ")
