        ...
        <div class="subNavBox">
            ...
            <div class="sBox">
                <div class="subNav sublist-up">
                    ...
                    <span class="sublist-title">服务器</span>
                </div>
                <ul class="navContent" style="display:none">
                    ...
                    <li>
                        <div class="showtitle" style="width:100px;">
                            <img src="/ecs/img/leftimg.png" />添加新闻
                        </div><a href="#"><span class="sublist-icon glyphicon glyphicon-user"></span><span class="sub-title">添加新闻</span></a></li>
                    <li>
                        <div class="showtitle" style="width:100px;">
                            <img src="/ecs/img/leftimg.png" />新闻管理
                        </div><a href="#"><span class="sublist-icon glyphicon glyphicon-user"></span><span class="sub-title">新闻管理</span></a></li>
                </ul>
            </div>
        </div>
