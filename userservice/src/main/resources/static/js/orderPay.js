...
$(function(){
    ...
    $(".slider-container").click(function(){
        ...
        $.ajax({
            type: "POST",
            dataType: "text",
            url: '/data/getorderMonthPrice',
            data:{month:aa,orderId:serverId},
        ...
        success: function (data) {
            if (data == "success") {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "text",
                    url: '/data/orderPay/pay',
                    data:{month:aa,id:serverId},
                    success: function (data) {
                        if(data == "success"){alert("支付成功！");window.location.href="/console/home";}else{alert("支付失败！余额不足！")}
